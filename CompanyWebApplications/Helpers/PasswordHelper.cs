...
public static class PasswordHelper
{
    ...
    public static string GetTokenString(string jwtToken, int minutesExp)
    {
        var secretKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(jwtToken));
        ...
        var tokeOptions = new JwtSecurityToken(
            ...
            expires: DateTime.Now.AddMinutes(minutesExp),
